			...
			<nav class="navbar navbar-expand-lg navbar-light">
				<div class="container-fluid">
                    ...
                    <a class="navbar-brand logo_h" href="{{ url('/') }}">
						<img src="{{asset('assets/img/tokoonline.png')}}" alt="" width="200px" height="50px">
					</a>
    ...
    <div class="container">
        <div class="row">
                    ...
                    <div id=mc_embed_signup>
                        <form target="_blank" action="https://spondonit.us12.list-manage.com/subscribe/post?u=1462626880ade1ac87bd9c93a&amp;id=92a4423d01" method="get" class="subscribe_form relative">
                            <div class="input-group d-flex flex-row">
                                <input name="EMAIL" type="email" placeholder="Email Address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email Address'" required>
            ...
            <div class="col-lg-2 col-md-6 col-sm-6">
                <div class="single_footer_widget f_social_wd">
                    ...
                    <div class="f_social">
                        ...
                        <a href="#">
                            <li class="fa fa-dribble"></li>
                        </a>
                        <a href="#">
                            <li class="fa fa-behance"></li>
                        </a>
                    </div>
                </div>
            </div>
            <div class="row footer-bottom d-flex justify-content-between align-items-center">
                <p class="col-lg-12 footer-text text-center">
                    ...
                    <i class="fa fa-heart-o" aria-hidden="true"></i>by : <a href="www.instagram.com" target="_blank">AnggaraMAG</a>
                </p>
            </div>
        </div>
    </div>
